...
const SignIn = (props) => {
  ...
  return (
     <div className='w-100 lg:w-[30%] bg-[#FDFEFE] shadow-[0_0_20px_rgba(128,128,128,0.332)] py-4 rounded-2xl'>
      ...
      <p className='mt-6 text-center text-md text-slate-600 mb-6'>
       Don't have an account? 
        <button className='font-semibold text-slate-900 hover:text-slate-700 transition-colors duration-200 cursor-pointer' onClick={() => props.settoggel(prev => !prev)}>Sign up</button>
      </p>
